...
export class LoginService {
  ...
  url_admin:string='http://localhost:50444/api/User/ValidateAdmin/'
  url_user:string='http://localhost:50444/api/User/ValidateUser/'
  url_signup:string='http://localhost:50444/api/User/Add'
